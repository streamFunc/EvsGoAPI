...
)
{
    ...
    else
    {
	  ...
	  headerSize = 1 * sizeof(UWord8);
	  bodySize = ((pFrame_size + 7) >> 3) * sizeof(UWord8);
...
)
{
    ...
    do
    {
		/*Sync header*/
		utmp = data[0];
	  headerSize = sizeof(unsigned short) * 1;
       ...
       offsetSize = headerSize + sizeof(unsigned short) * 1;
