...
int main( int argc, char** argv )
{
    ...
    while( (n_samples = (short)fread(data, sizeof(short), input_frame, f_input)) > 0 )
    {
        ...
        {
			      printf("ACELP_24k40 MODE2 frame:%ld \n", frame);
    ...
    InitEncoder(enc,8000,24400,"NB",0);
